                    ...
                    <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                        <div className="relative">
                            <div className="relative aspect-[4/3] overflow-hidden rounded-sm shadow-2xl">
                                <Image
                                    src="https://images.unsplash.com/photo-1541976544351-e43a6c2f90da?w=800&q=80"
                                    alt="Vijay Constructions History"
                                    width={800}
                                    height={600}
                ...
                <div className="container">
                    ...
                    <div className="grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
                        ...
                        <div className="group relative overflow-hidden rounded-sm bg-white/60 backdrop-blur-md shadow-xl border border-white/40">
                            <div className="aspect-[3/4] overflow-hidden relative bg-gradient-to-br from-steel-dark to-concrete-dark flex items-center justify-center">
