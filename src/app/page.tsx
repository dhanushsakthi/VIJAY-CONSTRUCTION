                ...
                <div className="container relative flex min-h-[100dvh] items-center">
                    ...
                    >
                        ...
                        <h1 className="hero-animate heading-xl mb-6 text-white drop-shadow-[0_2px_15px_rgba(0,0,0,0.5)] font-extrabold">
                            U dream{" "}
                            <span className="relative inline-block text-brand-green font-extrabold drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
                                We build
                            </span>
                        </h1>
                        ...
                        <div className="hero-animate flex flex-wrap gap-4">
                            <Link
                                ...
                                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-sm bg-brand-green px-8 py-4 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:shadow-xl"
                            >
