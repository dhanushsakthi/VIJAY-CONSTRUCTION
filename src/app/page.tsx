                    ...
                    >
                        ...
                        <div className="hero-animate flex flex-wrap gap-4">
                            <Link
                                ...
                                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-sm bg-brand-red px-8 py-4 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:shadow-xl"
                            >
