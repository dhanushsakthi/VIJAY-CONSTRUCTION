                    ...
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link
                                ...
                                className="group flex items-center gap-2 rounded-sm bg-brand-green px-8 py-4 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all hover:bg-steel-dark hover:text-white"
                            >
