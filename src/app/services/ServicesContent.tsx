                ...
                <div className="container relative">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <Link
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 rounded-sm bg-brand-red px-8 py-4 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all hover:bg-steel-dark hover:text-white"
                        >
