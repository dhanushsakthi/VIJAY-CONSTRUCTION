                ...
                <div className="grid gap-y-16 lg:grid-cols-[1.5fr_1fr_1fr_1fr] lg:gap-x-12">
                    ...
                    <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
                        ...
                        <Link
                            ...
                            className="mt-6 inline-flex items-center gap-2 rounded-sm bg-brand-red px-5 py-3 font-display text-sm font-semibold uppercase tracking-wider text-white transition-all hover:bg-brand-red-dark hover:shadow-lg shadow-construction"
                        >
