                    ...
                    <nav className="flex h-20 items-center justify-between lg:h-24">
                        ...
                        <Link href="/" className="group relative z-10 transition-transform duration-300 hover:scale-[1.02]">
                            <div className="flex items-center gap-3 lg:gap-5">
                                ...
                                {/* Logo Text */}
                                <div className={`flex items-center flex-nowrap transition-all duration-500 ${(pathname === "/" && !isScrolled) ? "opacity-0 translate-x-4 pointer-events-none" : "opacity-100 translate-x-0"}`}>
                                    <span
                                        className={`font-display text-lg sm:text-xl lg:text-2xl font-bold tracking-tight whitespace-nowrap transition-colors duration-300 drop-shadow-sm ${isScrolled ? "text-steel-dark" : "text-steel-dark"}`}
                                    >
                                        VIJAY
                                    </span>
                                    <span
                                        className={`ml-1.5 sm:ml-2 lg:ml-3 font-display text-lg sm:text-xl lg:text-2xl font-bold tracking-tight whitespace-nowrap transition-colors duration-300 drop-shadow-sm ${isScrolled ? "text-brand-green" : "text-brand-green"}`}
                                    >
                                        CONSTRUCTIONS
                                    </span>
                                </div>
                        ...
                        <div className="hidden lg:block">
                            <Link
                                ...
                                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-sm bg-brand-green px-6 py-3 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:bg-brand-green-dark hover:shadow-xl"
                            >
                                <svg className="relative z-10 h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
