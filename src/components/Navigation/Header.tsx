                    ...
                    <nav className="flex h-20 items-center justify-between lg:h-24">
                        ...
                        <div className="hidden lg:block">
                            <Link
                                ...
                                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-sm bg-brand-red px-6 py-3 font-display text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:bg-brand-red-dark hover:shadow-xl"
                            >
